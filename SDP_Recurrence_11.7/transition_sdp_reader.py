...
class SDPDatasetReader(DatasetReader):
    ...
    def _read(self, file_path: str):
        ...
        with open(file_path, 'r', encoding='utf-8') as fp:
            ...
            for ret in lazy_parse(fp.read()):
                ...
                # 使用yield产生生成器
                yield self.text_to_instance(tokens, arc_indices, arc_tags, pos_tags, token_characters, gold_actions, meta_info)
    ...
    def text_to_instance(self,  # type: ignore
        ...
        if pos_tags is not None:
            meta_dict["pos_tags"] = arc_tags
            fields["pos_tags"] = TextField([Token(a) for a in pos_tags], self._pos_tag_indexers)
